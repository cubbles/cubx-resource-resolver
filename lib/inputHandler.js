(function () {
  ...
  class InputHandler {
    ...
    async getOutputConf (data) {
      if (!data) {
        throw new Error('No outputConf parameter.');
      }
      if (typeof data === 'string') {
        if (data.startsWith('{')) {
          data = JSON.parse(data);
      ...
      if (typeof data === 'object') {
        return this._checkOutputConf(data);
      } else {
        throw new SyntaxError('The outputConf is not correct. Please define an object like this: {"htmlImport": "./output/html-imports.html", "javascript":"./output/scripts.js", "css": "./output/styles.css", "htmlImportJavascript": "./output/htmlImportScripts.js"}');
      }
    }
